...
// Datos de ejemplo para que la vista no esté vacía
const MOCK_DATA = {
  dayTotals: {
    salesCount: 42,
    totalAmount: 158400,
  ...
  cashiers: [
    {
      cashier: { id: 1, username: "Juan Perez" },
      status: "open",
      shift: { salesCount: 25, totalAmount: 95000 }
    },
    {
      cashier: { id: 2, username: "Maria Caja" },
      status: "closed",
      shift: { salesCount: 17, totalAmount: 63400 }
    }
  ]
};
...
export function AdminDashboardPage() {
  // Ahora usamos directamente los datos del MOCK
  ...
  return (
    <section className="space-y-6 pt-10">
      <header className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black">Dashboard Multi-Caja (Demo)</h1>
          <p className="text-sm text-slate-500">
            Vista estática de las ventas del día.
          </p>
        </div>
          ...
          >
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="rounded-2xl border border-orange-300 bg-orange-50 p-5">
                ...
                <div className="mt-2 text-sm text-slate-600">ventas realizadas</div>
              </div>
              ...
              <div className="rounded-2xl border border-orange-300 bg-orange-50 p-5">
                ...
                <div className="mt-2 text-sm text-slate-600">recaudado</div>
              </div>
            </div>

            <Link
              to={`/admin/caja/${c.cashier.id}`}
              className="mt-10 inline-flex w-full items-center justify-center rounded-2xl bg-orange-500 py-3 text-base font-extrabold text-white shadow-sm transition-colors hover:bg-orange-600 active:scale-[0.99]"
            >
